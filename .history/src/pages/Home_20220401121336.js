...
function Home() {
  ...
  <Card bg="danger" text="white" className="text-center" style={{margin: "10px", width: "44rem", height: "44rem"}}>
    <Card.Body>
      <Card.Title style={{fontSize:"50px"}}>Deaths</Card.Title>
      <Card.Text>
        {latest.deaths}
      </Card.Text>
    </Card.Body>
    <Card.Footer>
      <small style={{fontSize:"15px", lineHeight:"10px"}}> Last updated {lastUpdated}</small>
    </Card.Footer>
  </Card>
  <Card bg="success" text="white" className="text-center" style={{margin: "10px", width: "44rem", height: "44rem"}}>
    <Card.Body>
      <Card.Title style={{fontSize:"50px"}}>Recovered</Card.Title>
      <Card.Text>
        {latest.recovered}
      </Card.Text>
    </Card.Body>
