...
function About() {
  return ( 
    <div style={{ margin: "20px" }} className="about">
    <Tabs>
      <TabList>
        <Tab>Overview</Tab>
        <Tab>Symptoms</Tab>
      ...
      <img src={img1} alt=""/>
        ...
        <hr />
        <p className="hd">How It Spreads</p>
        <p>
      ...
      <img src={img2} alt=""/>
        ...
        <hr />
        <p className="hd">Most common symptoms:</p>
        <ul>
          <li>fever</li>
          <li>dry cough</li>
          <li>tiredness</li>
        </ul>
        <p className="hd">Less common symptoms:</p>
        <ul>
        ...
        <p className="hd">Serious symptoms:</p>
        <ul>
      ...
      <img src={img4} alt=""/>
        <p>
          ...
          taking appropriate precautions. Getting the COVID vaccine is another form of prevention. The vaccine is 100% effecive against moderate and severe disease. Make sure to get your booster vaccine as advised by healthcare professionals. Follow advice provided by your local
          public health agency.
        </p>
        <hr />
        <p className="hd">To prevent the spread of COVID-19:</p>
        <ul>
          <li>
      ...
      <img src={img3} alt=""/>
        <p>
          To date, there are no specific medicines for COVID-19.
          Treatments are under investigation, and will be tested through
          clinical trials.
        </p>
        <hr />
        <p className="hd">Self-care:</p>
        <p>
        ...
        <p className="hd">Medical treatments:</p>
        <p>
