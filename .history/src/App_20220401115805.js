...
const App = () => {
  return (
    ...
    <ul className="nav-list">
     <header style={{fontSize:'26px', paddingRight: "40px", textAlign: 'center'}}> COVID-19 Live Updates </header>
          <li style={{paddingRight: "40px"}}><Link to="/" className="link">Home</Link></li>
          <li style={{paddingRight: "40px"}}><Link to="/Countries" className="link">Country</Link></li>
